    ...
    public partial class JuiceBarForm : Form
    {
        ...
        private void orderCompleteButton_Click(object sender, EventArgs e)
        {
            ...
            if (itemPriceTextBox.Text != "")
            {
                ...
                responsibleDialogResult = MessageBox.Show(messageString, "Verify Last Drink Purchase", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
                if(responsibleDialogResult == DialogResult.Yes)
                {
        ...
        private void addToOrderButton_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    {
                        drinksInterger += quantityInteger;
